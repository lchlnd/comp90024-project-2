...
def create_instance(num_instances = 1, sys_type="webserver"):
...
def orchestrate():
    os.system("ansible-playbook deployment3.yml -i inventory3")
...
if __name__ == "__main__":
    ...
    """Create instance/s"""
    tweetdb = create_instance(1, sys_type="tweetdb")

    webserver = create_instance(1, sys_type="webserver")
